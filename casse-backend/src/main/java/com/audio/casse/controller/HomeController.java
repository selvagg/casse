...
public class HomeController {
     ...
     *
     * @param user The authenticated OAuth2 user principal, if available.
    ...
    @GetMapping("/home")
    public String home(@AuthenticationPrincipal(errorOnInvalidType = true) AuthenticatedUser user, Model model) {
